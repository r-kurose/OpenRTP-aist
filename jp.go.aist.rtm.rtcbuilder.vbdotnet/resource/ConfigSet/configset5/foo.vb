...
Public Class foo
    ...
    End Function
    Private m_str_param0Conf As List(Of string) = New List(Of string)()
    ...
    Protected Overrides Function onInitialize() As ReturnCode_t
        bindParameter("int_param0", "1", New RTC.Config.TransFunc(AddressOf int_param0Trans))
        bindParameter("str_param0", ""aaa","bbb","ccc"", New RTC.Config.TransFunc(AddressOf str_param0Trans))
...
Public Class fooInit
    ...
    { _
        ...
        "lang_type",         "COMPILE" _
        , "conf.default.int_param0",   "1" _
        , "conf.default.str_param0",   ""aaa","bbb","ccc"" _
    }
