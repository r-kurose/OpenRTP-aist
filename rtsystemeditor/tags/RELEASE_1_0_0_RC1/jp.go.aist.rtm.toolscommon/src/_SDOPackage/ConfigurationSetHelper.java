...
/**
* _SDOPackage/ConfigurationSetHelper.java .
* IDL-to-Java コンパイラ (ポータブル), バージョン "3.1" で生成
* 生成元: svn/jp.go.aist.rtm.systemeditor/idl/SDOPackage11.idl
* 2008年12月4日 (木曜日) 12時46分40秒 JST
*/

abstract public class ConfigurationSetHelper
{
  private static String  _id = "IDL:org.omg/SDOPackage/ConfigurationSet:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[2] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (_SDOPackage.ConfigurationSetHelper.id (), "ConfigurationSet", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    _SDOPackage.ConfigurationSet value = new _SDOPackage.ConfigurationSet ();
    value.id = istream.read_string ();
    value.description = istream.read_string ();
    value.configuration_data = _SDOPackage.NVListHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, _SDOPackage.ConfigurationSet value)
  {
    ...
    _SDOPackage.NVListHelper.write (ostream, value.configuration_data);
  }
