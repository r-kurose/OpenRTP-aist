...
//					getConnectorProfile());
			if( getSource() != null ) {
				removeByID(getSource().getPortProfile().getConnectorProfiles(),
					getConnectorProfile());
			}
			if( getTarget() != null ) {
				removeByID(getTarget().getPortProfile().getConnectorProfiles(),
					getConnectorProfile());
			}
	...
	private void removeByID(List profiles, ConnectorProfile cp) {
