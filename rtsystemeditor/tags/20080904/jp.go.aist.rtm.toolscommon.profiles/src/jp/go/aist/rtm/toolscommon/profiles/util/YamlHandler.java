...
public class YamlHandler {
		...
		if( profileYOrg != null ) {
			...
			if( profileY != null ) {
				...
				if( basicY != null ) {
					...
					//Basic ext
					if( basicY.get("rtcExt::versionUpLog")!=null )basic.getVersionUpLog().addAll((List)basicY.get("rtcExt::versionUpLog"));
	...
	private DataportExt createDataPortFromYaml(Map yamlMap) {
		...
		if( yamlMap.get("rtcExt::position")!=null )
			dataport.setPosition(Position.fromValue(((String)yamlMap.get("rtcExt::position")).toLowerCase()));
		dataport.setSubscriprionType((String)yamlMap.get("subscriprionType"));
		dataport.setType((String)yamlMap.get("type"));
		dataport.setVarname((String)yamlMap.get("rtcExt::varname"));
		//
	...
	private ServiceportExt createServicePortFromYaml(Map yamlMap) {
		...
		if( yamlMap.get("rtcExt::position")!=null )
			serviceport.setPosition(Position.fromValue(((String)yamlMap.get("rtcExt::position")).toLowerCase()));
		//
		Map portdocY = (Map)yamlMap.get("rtcDoc::doc");
		if( portdocY != null ) {
