...
{
  private static String  _id = "IDL:org.omg/SDOPackage/NVList:1.0";
  ...
  public static _SDOPackage.NameValue[] read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value = new _SDOPackage.NameValue[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = _SDOPackage.NameValueHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, _SDOPackage.NameValue[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      _SDOPackage.NameValueHelper.write (ostream, value[_i0]);
  }
