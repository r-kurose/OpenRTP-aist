...
{
  private static String  _id = "IDL:org.omg/SDOPackage/ParameterList:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = _SDOPackage.ParameterHelper.type ();
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (_SDOPackage.ParameterListHelper.id (), "ParameterList", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    _SDOPackage.Parameter value[] = null;
    int _len0 = istream.read_long ();
    value = new _SDOPackage.Parameter[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = _SDOPackage.ParameterHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, _SDOPackage.Parameter[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      _SDOPackage.ParameterHelper.write (ostream, value[_i0]);
  }
