...
/**
* _SDOPackage/NameValueHelper.java .
...
{
  private static String  _id = "IDL:org.omg/SDOPackage/NameValue:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (_SDOPackage.NameValueHelper.id (), "NameValue", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    _SDOPackage.NameValue value = new _SDOPackage.NameValue ();
