...
/*!
   ...
   * @endif
   */
public class _RTObjectStub extends org.omg.CORBA.portable.ObjectImpl implements RTC.RTObject
{
  ...
  /*!
     ...
     * @endif
     */
  public RTC.PortService[] get_ports ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("get_ports", true);
                $in = _invoke ($out);
                RTC.PortService $result[] = RTC.PortServiceListHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
