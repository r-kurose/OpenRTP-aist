...
{
  private static String  _id = "IDL:OpenRTMNaming/NameComponent:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (OpenRTMNaming.NameComponentHelper.id (), "NameComponent", __typeCode);
    }
    return __typeCode;
  }
  ...
  public static org.omg.CosNaming.NameComponent read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value = org.omg.CosNaming.NameComponentHelper.read (istream);
    return value;
  }

  public static void write (org.omg.CORBA.portable.OutputStream ostream, org.omg.CosNaming.NameComponent value)
  {
    org.omg.CosNaming.NameComponentHelper.write (ostream, value);
  }
