 ...
 * <ul>
 *   <li>{@link jp.go.aist.rtm.nameserviceview.model.manager.impl.NodeImpl#getNodes <em>Nodes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NodeImpl extends WrapperObjectImpl implements Node {
	...
	public EList<Node> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentEList<Node>(Node.class, this, ManagerPackage.NODE__NODES);
		}
		return nodes;
	}
