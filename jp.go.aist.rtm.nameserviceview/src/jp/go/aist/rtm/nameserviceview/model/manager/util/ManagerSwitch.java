...
public class ManagerSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ManagerPackage.NAME_SERVER_MANAGER: {
				...
				T result = caseNameServerManager(nameServerManager);
			...
			case ManagerPackage.NAME_SERVER_CONTEXT: {
				...
				T result = caseNameServerContext(nameServerContext);
	 ...
	 * @generated
	 */
	public T caseNameServerManager(NameServerManager object) {
		return null;
	}
