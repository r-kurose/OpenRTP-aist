...
import jp.go.aist.rtm.nameserviceview.model.manager.*;
...
public class ManagerAdapterFactory extends AdapterFactoryImpl {
	...
	protected ManagerSwitch<Adapter> modelSwitch =
		new ManagerSwitch<Adapter>() {
			@Override
			public Adapter caseNameServerManager(NameServerManager object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link jp.go.aist.rtm.nameserviceview.model.manager.NameServerManager <em>Name Server Manager</em>}'.
	 * <!-- begin-user-doc -->
