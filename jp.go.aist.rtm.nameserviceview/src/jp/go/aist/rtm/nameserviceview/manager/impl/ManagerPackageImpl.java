...
public class ManagerPackageImpl extends EPackageImpl implements ManagerPackage {
	 ...
	 * @see jp.go.aist.rtm.nameserviceview.manager.ManagerPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		addEOperation(nameServerManagerEClass, null, "refreshAll");

		EOperation op = addEOperation(nameServerManagerEClass, ecorePackage.getEBoolean(), "isExist", 0, 1);
		addEParameter(op, ecorePackage.getEString(), "nameServer", 0, 1);

		op = addEOperation(nameServerManagerEClass, this.getNameServerContext(), "addNameServer", 0, 1);
		addEParameter(op, ecorePackage.getEString(), "nameServer", 0, 1);

		op = addEOperation(nameServerManagerEClass, null, "setSynchronizeInterval");
