...
public class ManagerSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ManagerPackage.NAME_SERVER_MANAGER: {
				NameServerManager nameServerManager = (NameServerManager)theEObject;
				Object result = caseNameServerManager(nameServerManager);
				if (result == null) result = caseNode(nameServerManager);
				if (result == null) result = caseWrapperObject(nameServerManager);
				if (result == null) result = caseModelElement(nameServerManager);
				if (result == null) result = caseLocalObject(nameServerManager);
				if (result == null) result = caseIAdaptable(nameServerManager);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ManagerPackage.NAME_SERVER_CONTEXT: {
				NameServerContext nameServerContext = (NameServerContext)theEObject;
				Object result = caseNameServerContext(nameServerContext);
				if (result == null) result = caseNode(nameServerContext);
				if (result == null) result = caseWrapperObject(nameServerContext);
				if (result == null) result = caseModelElement(nameServerContext);
				if (result == null) result = caseLocalObject(nameServerContext);
				if (result == null) result = caseIAdaptable(nameServerContext);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ManagerPackage.NODE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Name Server Manager</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Name Server Manager</em>'.
