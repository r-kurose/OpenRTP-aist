...
/*!
   ...
   * @endif
   */
public abstract class FsmPOA extends org.omg.PortableServer.Servant
 implements RTC.FsmOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  public Fsm _this() 
  {
    return FsmHelper.narrow(
    super._this_object());
  }

  public Fsm _this(org.omg.CORBA.ORB orb) 
  {
    return FsmHelper.narrow(
