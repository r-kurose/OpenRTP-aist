...
/*!
   ...
   * @endif
   */
public abstract class FsmParticipantPOA extends org.omg.PortableServer.Servant
 implements RTC.FsmParticipantOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("on_action", new java.lang.Integer (19));
  }
  ...
  /*!
     ...
     * @endif
     */
       case 19:  // RTC/FsmParticipantAction/on_action
       {
         int exec_handle = RTC.ExecutionContextHandle_tHelper.read (in);
         RTC.ReturnCode_t $result = null;
  ...
  {
    return FsmParticipantHelper.narrow(
    super._this_object());
  }

  public FsmParticipant _this(org.omg.CORBA.ORB orb) 
  {
    return FsmParticipantHelper.narrow(
