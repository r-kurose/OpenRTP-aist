 ...
 * </copyright>
 *
 * $Id: EIntegerObjectToPointMapEntryImpl.java,v 1.1 2008/01/29 05:52:23 yamashita Exp $
 */
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EInteger Object To Point Map Entry</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class EIntegerObjectToPointMapEntryImpl extends EObjectImpl implements BasicEMap.Entry<Integer,Point> {
	 ...
	 * @generated
	 */
	protected EIntegerObjectToPointMapEntryImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ComponentPackage.Literals.EINTEGER_OBJECT_TO_POINT_MAP_ENTRY;
	}
	...
	public void setTypedKey(Integer newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.EINTEGER_OBJECT_TO_POINT_MAP_ENTRY__KEY, oldKey, key));
	}
	...
	public void setTypedValue(Point newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.EINTEGER_OBJECT_TO_POINT_MAP_ENTRY__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ComponentPackage.EINTEGER_OBJECT_TO_POINT_MAP_ENTRY__KEY:
				return getTypedKey();
			case ComponentPackage.EINTEGER_OBJECT_TO_POINT_MAP_ENTRY__VALUE:
