...
public class fooImpl extends DataFlowComponentBase {
   ...
   */
	public fooImpl(Manager manager) {  
        ...
        m_cmPortPort.registerConsumer("rate", "DAQService", m_rinstBase);
...
//
    ...
    /*!
     */
    protected MyServiceSVC_impl m_acinst = new MyServiceSVC_impl();
    
    // </rtc-template>

    // Consumer declaration
    // <rtc-template block="consumer_declare">
    protected CorbaConsumer<DAQService> m_rinstBase = new CorbaConsumer<DAQService>(DAQService.class);
    /*!
     */
    protected DAQService m_rinst;
