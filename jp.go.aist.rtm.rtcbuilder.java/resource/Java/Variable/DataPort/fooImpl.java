...
public class fooImpl extends DataFlowComponentBase {
   ...
   */
	public fooImpl(Manager manager) {  
        ...
        m_VarInP1_val = new TimedShort();
        m_VarInP1 = new DataRef<TimedShort>(m_VarInP1_val);
        m_InP1In = new InPort<TimedShort>("InP1", m_VarInP1);
        ...
        m_VarOutP2_val = new TimedFloat();
        m_VarOutP2 = new DataRef<TimedFloat>(m_VarOutP2_val);
        m_OutP2Out = new OutPort<TimedFloat>("OutP2", m_VarOutP2);
        // </rtc-template>
...
//
    ...
    protected TimedShort m_VarInP1_val;
    protected DataRef<TimedShort> m_VarInP1;
    /*!
     */
    ...
    protected TimedFloat m_VarOutP2_val;
    protected DataRef<TimedFloat> m_VarOutP2;
    /*!
     */
