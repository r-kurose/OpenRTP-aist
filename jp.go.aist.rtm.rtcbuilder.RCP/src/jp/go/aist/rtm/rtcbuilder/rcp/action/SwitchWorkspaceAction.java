...
import jp.go.aist.rtm.rtcbuilder.rcp.RtcBuilderActivator;
...
public class SwitchWorkspaceAction extends Action implements
	...
	class OpenDialogAction extends Action {
		 ...
		 */
		public void run() {
			SwitchWorkspaceAction.this.run();
		}
	}
	...
	public static final String CMD_DATA = "-data"; //$NON-NLS-1$
	...
	private void restart(String path) {
		...
		Preferences.userNodeForPackage(RtcBuilderActivator.class).put("workspace", command_line);
