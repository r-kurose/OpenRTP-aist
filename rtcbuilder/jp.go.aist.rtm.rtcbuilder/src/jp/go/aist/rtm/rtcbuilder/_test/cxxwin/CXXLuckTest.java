...
public class CXXLuckTest extends TestBase {
	...
	public void testConsumerNoName() throws Exception{
		...
		String resourceDir = rootPath +  "\\resource\\CXXWin\\Exception\\ConNoName\\";
...
//		checkCode(result, resourceDir, "README.foo");
	...
	public void testConsumerNoPortName() throws Exception{
		...
		String resourceDir = rootPath +  "\\resource\\CXXWin\\Exception\\ConNoPortName\\";
...
//		checkCode(result, resourceDir, "README.foo");
	...
	public void testProviderNoName() throws Exception{
		...
		String resourceDir = rootPath +  "\\resource\\CXXWin\\Exception\\ProNoName\\";
...
//		checkCode(result, resourceDir, "README.foo");
	...
	public void testProviderNoPortName() throws Exception{
		...
		String resourceDir = rootPath +  "\\resource\\CXXWin\\Exception\\ProNoPortName\\";
...
//		checkCode(result, resourceDir, "README.foo");
	...
	public void testOutPortNoType() throws Exception{
		...
		String resourceDir = rootPath +  "\\resource\\CXXWin\\Exception\\OutPortNoType\\";
...
//		checkCode(result, resourceDir, "README.foo");
	...
	public void testOutPortNoName() throws Exception{
		...
		String resourceDir = rootPath +  "\\resource\\CXXWin\\Exception\\OutPortNoName\\";
...
//		checkCode(result, resourceDir, "foo.cpp");
	...
	public void testInPortNoType() throws Exception{
		...
		String resourceDir = rootPath +  "\\resource\\CXXWin\\Exception\\InPortNoType\\";
	...
	public void testInPortNoName() throws Exception{
		...
		String resourceDir = rootPath +  "\\resource\\CXXWin\\Exception\\InPortNoName\\";
