...
public class CXXDiffTest extends TestBase {
	...
	public void testDiffName2() throws Exception{
		...
		ServicePortInterfaceParam int1 = new ServicePortInterfaceParam(service1, "myservice0", "", "", 
				rootPath + "\\resource\\042\\CXX\\diffname2\\MyService3.idl", "MyService", "", 0);
		srvinterts.add(int1);
		...
		String resourceDir = rootPath +  "\\resource\\042\\CXX\\diffname2\\";
	...
	public void testDiffName() throws Exception{
		...
		List<ServicePortInterfaceParam> srvinterts = new ArrayList<ServicePortInterfaceParam>(); 
		ServicePortInterfaceParam int1 = new ServicePortInterfaceParam(service1, "myservice0", "", "", 
				rootPath + "resource\\042\\CXX\\diffname\\MyService3.idl", "MyService", "", 0);
		srvinterts.add(int1);
		service1.setServicePortInterfaces(srvinterts);
		List<ServicePortParam> srvports = new ArrayList<ServicePortParam>();
		srvports.add(service1);
		...
		String resourceDir = rootPath +  "\\resource\\042\\CXX\\diffname\\";
