...
public class CXXVarTest extends TestBase {
	...
	public void testConfigSetVar() throws Exception{
		...
		configset.add(new ConfigSetParam("str_param1","std::string","varname3", "data"));
		rtcParam.setConfigParams(configset);

		Generator generator = new Generator();
		List<GeneratedResult> result = generator.generateTemplateCode(genParam);

		String resourceDir = rootPath +  "\\resource\\CXXWin\\ConfigSet\\ConfigVar\\";
...
//		checkCode(result, resourceDir, "README.foo");
	...
	public void testDataPortVar() throws Exception{
		...
		String resourceDir = rootPath +  "\\resource\\CXXWin\\PortVar\\";
