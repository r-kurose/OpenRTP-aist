...
public class CXXTemplateTestAIST extends TestBase {
	...
	public void testAIST5() throws Exception{
		...
		ServicePortInterfaceParam int1 = new ServicePortInterfaceParam(service1, "myservice0", "", "", 
				rootPath + "resource\\042\\CXX\\AIST5\\MyService.idl", "MyServiceT", "", 0);
		srvinterts.add(int1);
		...
		ServicePortInterfaceParam int2 = new ServicePortInterfaceParam(service1, "myservice", "", "", 
				rootPath + "resource\\042\\CXX\\AIST5\\MyService.idl", "MyServiceOpen", "", 0);
		...
		String resourceDir = rootPath +  "\\resource\\042\\CXX\\AIST5\\";
	...
	public void testAIST4() throws Exception{
		...
		List<ServicePortInterfaceParam> srvinterts = new ArrayList<ServicePortInterfaceParam>(); 
		ServicePortInterfaceParam int1 = new ServicePortInterfaceParam(service1, "myservice0", "", "", 
				rootPath + "resource\\042\\CXX\\AIST4\\MyService.idl", "MyService", "", 0);
		srvinterts.add(int1);
		service1.setServicePortInterfaces(srvinterts);
		List<ServicePortParam> srvports = new ArrayList<ServicePortParam>();
		srvports.add(service1);
		...
		String resourceDir = rootPath +  "\\resource\\042\\CXX\\AIST4\\";
	...
	public void testAIST3() throws Exception{
		...
		List<ServicePortInterfaceParam> srvinterts = new ArrayList<ServicePortInterfaceParam>(); 
		ServicePortInterfaceParam int1 = new ServicePortInterfaceParam(service1, "myservice0", "", "", 
				rootPath + "resource\\042\\CXX\\AIST3\\MyService.idl", "MyService", "", 0);
		srvinterts.add(int1);
		service1.setServicePortInterfaces(srvinterts);
		List<ServicePortParam> srvports = new ArrayList<ServicePortParam>();
		srvports.add(service1);
		...
		ServicePortInterfaceParam int2 = new ServicePortInterfaceParam(service1, "myservice1", "", "", 
				rootPath + "resource\\042\\CXX\\AIST3\\MyService.idl", "MyService", "", 1);
		srvinterts2.add(int2);
		service2.setServicePortInterfaces(srvinterts2);
		srvports.add(service2);
		rtcParam.setServicePorts(srvports);
		...
		String resourceDir = rootPath +  "\\resource\\042\\CXX\\AIST3\\";
	...
	public void testAIST2() throws Exception{
		...
		ServicePortInterfaceParam int1 = new ServicePortInterfaceParam(service1, "myservice", "", "", 
				rootPath + "resource\\042\\CXX\\AIST2\\MyService.idl", "MyService", "", 1);
		srvinterts.add(int1);
		service1.setServicePortInterfaces(srvinterts);
		List<ServicePortParam> srvports = new ArrayList<ServicePortParam>();
		srvports.add(service1);
		...
		String resourceDir = rootPath +  "\\resource\\042\\CXX\\AIST2\\";
	...
	public void testType() throws Exception{
		...
		List<ServicePortInterfaceParam> srvinterts = new ArrayList<ServicePortInterfaceParam>(); 
		ServicePortInterfaceParam int1 = new ServicePortInterfaceParam(service1, "myservice", "", "", 
				rootPath + "resource\\042\\CXX\\type\\MyService.idl", "MyService", "", 0);
		srvinterts.add(int1);
		service1.setServicePortInterfaces(srvinterts);
		List<ServicePortParam> srvports = new ArrayList<ServicePortParam>();
		srvports.add(service1);
		...
		String resourceDir = rootPath +  "\\resource\\042\\CXX\\type\\";
	...
	public void testServicePort() throws Exception{
		...
		List<ServicePortInterfaceParam> srvinterts = new ArrayList<ServicePortInterfaceParam>(); 
		ServicePortInterfaceParam int1 = new ServicePortInterfaceParam(service1, "myservice", "", "", 
				rootPath + "resource\\042\\CXX\\AIST1\\MyService.idl", "MyService", "", 0);
		srvinterts.add(int1);
		service1.setServicePortInterfaces(srvinterts);
		List<ServicePortParam> srvports = new ArrayList<ServicePortParam>();
		srvports.add(service1);
		...
		String resourceDir = rootPath +  "\\resource\\042\\CXX\\AIST1\\";
