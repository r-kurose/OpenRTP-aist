...
public class VbDotNetTestAIST extends TestBase {
	...
	public void testAIST5() throws Exception{
		...
		checkCode(result, resourceDir, "Test.vb");
		checkCode(result, resourceDir, "Test.vbproj");
		checkCode(result, resourceDir, "Test.vbproj.user");
//		checkCode(result, resourceDir, "gen.xml");
		checkCode(result, resourceDir, "Program.vb");
		checkCode(result, resourceDir, "MyServiceTImpl.vb");
		checkCode(result, resourceDir, "MyServiceOpenImpl.vb");
		//
