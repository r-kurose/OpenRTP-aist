 ...
 * <ul>
 *   <li>{@link jp.go.aist.rtm.nameserviceview.model.manager.NameServerContext#getNameServerName <em>Name Server Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see jp.go.aist.rtm.nameserviceview.model.manager.ManagerPackage#getNameServerContext()
 * @model
 * @generated
 */
public interface NameServerContext extends Node {
	 ...
	 * @see jp.go.aist.rtm.nameserviceview.model.manager.ManagerPackage#getNameServerContext_NameServerName()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link jp.go.aist.rtm.nameserviceview.model.manager.NameServerContext#getNameServerName <em>Name Server Name</em>}' attribute.
	 * <!-- begin-user-doc -->
