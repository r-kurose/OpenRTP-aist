...
class foo(OpenRTM_aist.DataFlowComponentBase):
	...
	def onInitialize(self):
		...
		self._sv_namePort.registerConsumer("if_name1", "SimpleService::MyService", self._if_name1)
		self._sv_namePort.registerConsumer("if_name2", "DAQService", self._if_name2)
