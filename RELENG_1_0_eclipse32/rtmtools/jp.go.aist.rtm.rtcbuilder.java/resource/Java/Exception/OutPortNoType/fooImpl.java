...
public class fooImpl extends DataFlowComponentBase {
   ...
   */
	public fooImpl(Manager manager) {  
        ...
        m_out1_val = new ();
        m_out1 = new DataRef<>(m_out1_val);
        m_out1Out = new OutPort<>("out1", m_out1);
        // </rtc-template>
        ...
        // Set OutPort buffer
        try {
			registerOutPort(.class, "out1", m_out1Out);
		} catch (Exception e) {
			e.printStackTrace();
		}
...
//
    ...
    protected  m_out1_val;
    protected DataRef<> m_out1;
    /*!
     */
    protected OutPort<> m_out1Out;
