...
//		assertEquals(port1, connector2.getSource());
	...
	private void setupPort1() {
		...
		port1.setOriginalPortString(getOriginalPortString("RTC:Sample Vender.example.CameraComponent:1.0.0", "CameraComponent_1", "ImageData"));
	}
	private void setupPort2() {
		...
		port2.setNameL("ImageDataIn");
		port2.setOriginalPortString(getOriginalPortString("RTC:Sample Vender.example.ImageViewer:1.0.0", "ImageViewer_1", "ImageDataIn"));
	}
	private void setupPort3() {
		...
		port3.setOriginalPortString(getOriginalPortString("RTC:Sample Vender.example.ImageViewer:1.0.0", "ImageViewer_1", "ImageDataIn"));
	}
