...
public class fooImpl extends DataFlowComponentBase {
   ...
   */
	public fooImpl(Manager manager) {  
        ...
        m_InName1_val = new TimedShort();
        m_InName1 = new DataRef<TimedShort>(m_InName1_val);
        m_InP1In = new InPort<TimedShort>("InP1", m_InName1);
        m_InNm2_val = new TimedLong();
        m_InNm2 = new DataRef<TimedLong>(m_InNm2_val);
        m_InP2In = new InPort<TimedLong>("InP2", m_InNm2);
        m_OutName1_val = new TimedLong();
        m_OutName1 = new DataRef<TimedLong>(m_OutName1_val);
        m_OutP1Out = new OutPort<TimedLong>("OutP1", m_OutName1);
        m_OutNme2_val = new TimedFloat();
        m_OutNme2 = new DataRef<TimedFloat>(m_OutNme2_val);
        m_OutP2Out = new OutPort<TimedFloat>("OutP2", m_OutNme2);
...
//
    ...
    protected TimedShort m_InName1_val;
    protected DataRef<TimedShort> m_InName1;
    /*!
     */
    protected InPort<TimedShort> m_InP1In;

    protected TimedLong m_InNm2_val;
    protected DataRef<TimedLong> m_InNm2;
    /*!
     */
    ...
    protected TimedLong m_OutName1_val;
    protected DataRef<TimedLong> m_OutName1;
    /*!
     */
    protected OutPort<TimedLong> m_OutP1Out;

    protected TimedFloat m_OutNme2_val;
    protected DataRef<TimedFloat> m_OutNme2;
    /*!
     */
