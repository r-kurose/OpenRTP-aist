...
class test(OpenRTM_aist.DataFlowComponentBase):
	...
	def __init__(self, manager):
		...
		"""
		"""
		self._MySVPro0Port = OpenRTM_aist.CorbaPort("MySVPro0")
		"""
		"""
		self._MySVPro1Port = OpenRTM_aist.CorbaPort("MySVPro1")
		"""
		"""
	...
	def onInitialize(self):
		...
		self.addPort(self._MySVPro0Port)
		self.addPort(self._MySVPro1Port)
