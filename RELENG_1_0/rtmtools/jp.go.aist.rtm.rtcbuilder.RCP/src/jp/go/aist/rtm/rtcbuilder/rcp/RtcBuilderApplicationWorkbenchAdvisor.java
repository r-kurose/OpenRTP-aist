...
public class RtcBuilderApplicationWorkbenchAdvisor extends WorkbenchAdvisor {

//	private static final String PERSPECTIVE_ID = "jp.go.aist.rtm.rtcbuilder.RCP.perspective";
	private static final String PERSPECTIVE_ID = "jp.go.aist.rtm.rtcbuilder.ui.perspective";
	public WorkbenchWindowAdvisor createWorkbenchWindowAdvisor(
			IWorkbenchWindowConfigurer configurer) {
		return new RtcBuilderApplicationWorkbenchWindowAdvisor(configurer);
	}
