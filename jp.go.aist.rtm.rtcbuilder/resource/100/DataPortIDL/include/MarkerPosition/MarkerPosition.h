  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  MarkerPosition(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~MarkerPosition() override;
...
extern "C"
{
  DLL_EXPORT void MarkerPositionInit(RTC::Manager* manager);
};

#endif // MARKERPOSITION_H