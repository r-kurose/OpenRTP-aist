...
public class CXX042TemplateTestAIST3 extends TestBase {
	...
	public void testAIST7() throws Exception{
		...
		ServicePortInterfaceParam int1 = new ServicePortInterfaceParam(service1, "acc", "", "", 
				rootPath + "resource\\100\\CXX\\AIST7\\Service1.idl", "test", "", 0);
		srvinterts.add(int1);
		...
		String targetDir = rootPath + "resource\\100\\CXX\\AIST7\\";
	...
	public void testAIST6() throws Exception{
		...
		List<ServicePortInterfaceParam> srvinterts = new ArrayList<ServicePortInterfaceParam>(); 
		ServicePortInterfaceParam int1 = new ServicePortInterfaceParam(service1, "acc", "", "", 
				rootPath + "resource\\100\\CXX\\AIST6\\Service1.idl", "test", "", 0);
		srvinterts.add(int1);
		service1.getServicePortInterfaces().addAll(srvinterts);
		List<ServicePortParam> srvports = new ArrayList<ServicePortParam>();
		srvports.add(service1);
		...
		String targetDir = rootPath + "resource\\100\\CXX\\AIST6\\";
